...
function myName(name) {
  ...
  function replaceLastName(fullName, newLastName) {
    ...
    finalFullName = newFullName.replace(",", " ");
  ...
  function capitalizeLastName(fullName) {
    let capitalizeLastName = (fullName.indexOf(" ") + 1);
    capitalize = fullName[capitalizeLastName].toUpperCase();
    finishedCapital = fullName.replace(fullName[capitalizeLastName],capitalize);
    return finishedCapital
